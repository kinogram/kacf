...
function applyStaticCopyToDom() {
    ...
    const staticMap = [
        ...
        ['label_vm_self_debug_cycles', 'label_vm_self_debug_cycles'],
        ['label_vm_self_debug_fix_cmd', 'label_vm_self_debug_fix_cmd'],
        ...
        ['label_vm_self_debug_max_runtime_sec', 'label_vm_self_debug_max_runtime_sec'],
        ...
        ['label_vm_health_self_heal', 'label_vm_health_self_heal'],
    ...
    const buttonTextMap = [
        ...
        ['vm_health_scan_btn', 'btn_vm_health_scan'],
        ...
        ['vm_self_debug_preview_btn', 'btn_vm_self_debug_preview'],
        ['vm_self_debug_start_btn', 'btn_vm_self_debug_start'],
        ['vm_self_debug_runs_refresh_btn', 'btn_vm_self_debug_runs_refresh'],
        ['vm_self_debug_history_refresh_btn', 'btn_vm_self_debug_history_refresh'],
        ['vm_self_debug_history_detail_btn', 'btn_vm_self_debug_history_detail'],
        ['vm_self_debug_history_archive_btn', 'btn_vm_self_debug_history_archive'],
        ['vm_self_debug_history_clear_btn', 'btn_vm_self_debug_history_clear'],
        ['vm_self_debug_stats_btn', 'btn_vm_self_debug_stats'],
        ['vm_self_debug_detail_btn', 'btn_vm_self_debug_detail'],
        ['vm_self_debug_context_btn', 'btn_vm_self_debug_context'],
        ['vm_self_debug_apply_context_btn', 'btn_vm_self_debug_apply_context'],
    ...
    const placeholderMap = [
        ...
        ['vm_self_debug_cycles', 'ph_vm_self_debug_cycles'],
        ['vm_self_debug_fix_cmd', 'ph_vm_self_debug_fix_cmd'],
        ['vm_self_debug_verify_cmd', 'ph_vm_self_debug_verify_cmd'],
        ['vm_self_debug_success_streak_target', 'ph_vm_self_debug_success_streak_target'],
        ['vm_self_debug_fail_streak_target', 'ph_vm_self_debug_fail_streak_target'],
        ['vm_self_debug_run_id', 'ph_vm_self_debug_run_id'],
        ['vm_self_debug_strategy_rules', 'ph_vm_self_debug_strategy_rules'],
